...
class Walk20Task implements TaskInterface
{
...
//        }
    ...
    public function rewards()
    {
        try {
            ...
            //检查有没有完成
            if (!$this->check())
                throw new \Exception('您还未完成20公里健走',50000);
            //检查助力次数
    ...
    public function check()
    {
        try {
            ...
            if ($userWork && $userWork['kilometre'] >= 20 && $userWork['total_times'] >= 10)
                return true;
